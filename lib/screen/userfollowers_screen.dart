...
class UserFollowersScreen extends StatefulWidget {
  static const routeName = '/userProfileScreen/userFollowersScreen';
...
class _UserFollowersState extends State<UserFollowersScreen> {
  User user;
  _Controller con;
  BKUser bkUser;
  BKUser userProfile;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("${userProfile.displayName}'s Followers"),
      ),
      body: userProfile.followers.length == 0
          ? Center(
              child: Text(
                '${userProfile.displayName} has no followers',
                style: TextStyle(
                  fontSize: 20.0,
